...
class NIGLoss:
    ...
    def __call__(self, evidential_params_, y):
        ...
        # TODO: DO we get a nan in the loss?
...
class NIGLoss_OLD:
    ...
    def __call__(self, evidential_params_, y):
        ...
        # Compute total loss
        total_loss = nll_loss + (self.lambd_ * reg_loss)
        # TODO: reconsider nanmean...
        return ('Loss', total_loss.nanmean()), {'NLL': nll_loss.nanmean(), 'REG': reg_loss.nanmean()}
